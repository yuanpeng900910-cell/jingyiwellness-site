...
const products = [
  ...
  { category: "节气养生系列", series: "节气内容产品", name: "顺时而养 · 二十四节气养生历", target: "节气养生关注人群", spec: "内容产品", formula: "二十四节气养生内容", intro: "围绕节气节律的日常养生内容产品。", price: null, priceText: "", showPrice: false, image: "images/common/product-placeholder.jpg" },
  { category: "节气养生系列", series: "节气内容产品", name: "顺时而养 · Companion OS", target: "节气养生关注人群", spec: "内容产品", formula: "节气陪伴内容系统", intro: "以节气为线索的陪伴式内容产品。", price: null, priceText: "", showPrice: false, image: "images/common/product-placeholder.jpg" },
