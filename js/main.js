...
const products = [
  ...
  { category: "药食养方", series: "功能小罐茶系列", name: "红颜茶", target: "女性关爱人群", spec: "代茶饮，充氮锁鲜小罐装，15g/罐×8罐", formula: "阿胶、红参、桑葚、玫瑰等（待确认）", intro: "女性日常轻养方向小罐茶，适合女性关爱、节日礼赠及办公室饮用场景。", price: "", image: "images/gongneng-xiaoguan-cha/hongyan-cha.jpg" },
  { category: "药食养方", series: "功能小罐茶系列", name: "轻湿茶", target: "轻负担生活方式人群", spec: "代茶饮，充氮锁鲜小罐装，15g/罐×8罐", formula: "赤小豆、芡实、炒薏米等（待确认）", intro: "轻湿方向小罐茶，适合夏季、办公室及轻负担生活方式场景。", price: "", image: "images/gongneng-xiaoguan-cha/qingshi-cha.jpg" },
  { category: "药食养方", series: "功能小罐茶系列", name: "元气茶", target: "加班/出差/高强度工作人群", spec: "代茶饮，充氮锁鲜小罐装，15g/罐×8罐", formula: "人参、黑枸杞、桑葚等（待确认）", intro: "元气补给方向小罐茶，适合加班、出差及高强度工作人群的日常饮用场景。", price: "", image: "images/gongneng-xiaoguan-cha/yuanqi-cha.jpg" },
  { category: "药食养方", series: "功能小罐茶系列", name: "熬夜茶", target: "熬夜/久坐办公人群", spec: "代茶饮，充氮锁鲜小罐装，15g/罐×8罐", formula: "黑枸杞、决明子、乌梅等（待确认）", intro: "面向熬夜与久坐办公人群的代茶饮，适合办公室、夜班及年轻客群沟通。", price: "", image: "images/gongneng-xiaoguan-cha/aoye-cha.jpg" },
  ...
  { category: "药食养方", series: "国民经典饮品系列", name: "五红汤", target: "女性关爱/家庭饮用人群", spec: "代茶饮，充氮锁鲜小罐装，15g/罐×8罐", formula: "红枣、红豆、红皮花生、枸杞、红糖等（待确认）", intro: "女性关爱及温暖养护方向饮品，适合节日礼赠、企业福利及家庭饮用。", price: "", image: "images/guomin-jingdian-yinpin/wuhong-tang.jpg" },
  { category: "药食养方", series: "国民经典饮品系列", name: "秋梨汤", target: "秋冬清润/家庭常备人群", spec: "代茶饮，充氮锁鲜小罐装，15g/罐×8罐", formula: "秋梨、百合、银耳等（待确认）", intro: "清润方向经典饮品，适合秋冬季、家庭常备及节令养生场景。", price: "", image: "images/guomin-jingdian-yinpin/qiuli-tang.jpg" },
  { category: "药食养方", series: "国民经典饮品系列", name: "姜枣茶", target: "秋冬暖养/家庭常备人群", spec: "代茶饮，充氮锁鲜小罐装，15g/罐×8罐", formula: "生姜、红枣、红糖等（待确认）", intro: "温暖调性的经典茶饮，适合秋冬季、空调房、家庭常备及日常暖养饮用场景。", price: "", image: "images/guomin-jingdian-yinpin/jiangzao-cha.jpg" },
  ...
  { category: "药食养方", series: "滋补系列", name: "茯苓糕", target: "健康零食/茶点人群", spec: "150g×2袋", formula: "粳米、茯苓粉等（待确认）", intro: "0蔗糖，药食同源糕点产品，适合茶点、伴手礼及健康零食场景。", price: "", image: "images/zibu-xilie/fuling-gao.jpg" },
  { category: "药食养方", series: "滋补系列", name: "五黑丸", target: "营养轻食/办公室零食人群", spec: "150g×2袋", formula: "黑芝麻、黑豆、黑米、黑枸杞等（待确认）", intro: "0蔗糖，黑色食材组合，适合日常营养补充、办公室零食及送礼。", price: "", image: "images/zibu-xilie/wuhei-wan.jpg" },
  { category: "药食养方", series: "轻养膳食系列", name: "五行馒头", target: "家庭早餐/轻养主食人群", spec: "冷冻/预包装，五种口味", formula: "面粉、中药粉、酵母等（待确认）", intro: "药食同源配方思路下的日常轻养主食，适合家庭早餐、健康餐搭配及员工福利场景。", price: "", image: "images/qingyang-shanshi/wuxing-mantou.jpg" },
  ...
  { category: "生活养方", series: "草本生活用品系列", name: "草本植萃药香梳", target: "日常梳理/东方香养人群", spec: "盒装", formula: "何首乌、侧柏叶、苦参、丹参等（待确认）", intro: "草本植萃香梳，以何首乌、侧柏叶等东方草本意象为特色，适合日常梳理、伴手礼及中式生活方式场景。", price: "", image: "images/caoben-shenghuo-yongpin/caoben-zhicui-yaoxiang-shu.jpg" },
  ...
  { category: "生活养方", series: "草本生活用品系列", name: "草本合香珠", target: "香枕填充/衣柜香氛/礼赠人群", spec: "盒装", formula: "20味中草药搭配组合（待确认）", intro: "以多味草本香材搭配，香气层次丰富，适合香枕填充、衣柜香氛及东方香养场景。", price: "", image: "images/caoben-shenghuo-yongpin/caoben-hexiang-zhu.jpg" },
